...
SCOPES = "https://www.googleapis.com/auth/calendar https://www.googleapis.com/auth/calendar.events https://www.googleapis.com/auth/gmail.modify https://www.googleapis.com/auth/gmail.settings.basic https://www.googleapis.com/auth/admin.directory.device.chromeos.readonly https://www.googleapis.com/auth/admin.directory.user.readonly"
...
async def sync_bidirectional(db) -> dict:
    ...
    await db.execute(
        "DELETE FROM planning_events WHERE "
        "title IN ('Bureau', 'Office', 'Working from office', 'Working from home', 'Domicile', 'Travail') "
        "OR title LIKE 'Bureau%' OR title LIKE 'Office%' OR title LIKE 'Domicile%' OR title LIKE 'Travail%'"
    )
